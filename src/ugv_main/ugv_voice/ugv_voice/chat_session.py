...
DEFAULT_SYSTEM_PROMPT = (
    ...
    'Jokes, stories, songs and questions are answered in words alone, '
    'never with a tool; only call record_replay when the user asks to be '
    'recorded or to hear their own voice played back. '
